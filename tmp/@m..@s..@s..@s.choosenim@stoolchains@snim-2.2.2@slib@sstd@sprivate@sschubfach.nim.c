...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -pthread -O3   -I/home/gregis/.choosenim/toolchains/nim-2.2.2/lib -I/home/gregis/Projects/OneLastBeat/src -o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@sstd@sprivate@sschubfach.nim.c.o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@sstd@sprivate@sschubfach.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Single__wbQmMlshRa08JoTGgPj9bXw, constructSingle__stdZprivateZschubfach_u50)(NF32 value_p0) {
	tyObject_Single__wbQmMlshRa08JoTGgPj9bXw result;
	NU32 colontmpD_;
	union { NF32 source; NU32 dest; } LOC1;
	nimZeroMem((void*)(&result), sizeof(tyObject_Single__wbQmMlshRa08JoTGgPj9bXw));
	colontmpD_ = (NU32)0;
