...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -pthread -flto -O3   -I/home/gregis/.choosenim/toolchains/nim-2.2.2/lib -I/home/gregis/Projects/OneLastBeat/src -o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@spure@shashes.nim.c.o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@spure@shashes.nim.c */
...
LA10_: ;
	{
		...
		y = (NU32)((NU32)(a_3) + (NU32)((NU32)((NU32)(b_2) << (NU32)(((NI)8)))));
		T19_ = (NU64)0;
		T19_ = lenU__pureZhashes_u339(s_p0, s_p0Len_0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		z = (NU64)((NU64)(T19_) + (NU64)(((NU64) ((NU32)((NU32)(c_2) << (NU32)(((NI)2)))))));
		T20_ = (NU64)0;
