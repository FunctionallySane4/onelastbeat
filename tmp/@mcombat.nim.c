...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -pthread -flto -O3   -I/home/gregis/.choosenim/toolchains/nim-2.2.2/lib -I/home/gregis/Projects/OneLastBeat/src -o /home/gregis/Projects/OneLastBeat/tmp/@mcombat.nim.c.o /home/gregis/Projects/OneLastBeat/tmp/@mcombat.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(tyTuple__bRyhXH2W6bAwxmsy78A9c3g, get_hitbox__combat_u4)(tyObject_CharactercolonObjectType___GNtIvodqMgdkSCDNOnirUw* character_p0, NI frame_p1);
static N_INLINE(void, nimZeroMem)(void* p_p0, NI size_p1);
static N_INLINE(void, nimSetMem__systemZmemory_u7)(void* a_p0, int v_p1, NI size_p2);
static N_INLINE(NIM_BOOL*, nimErrorFlag)(void);
static N_INLINE(NF32, toPfloat__pkgZnico_u7291)(NI x_p0);
N_LIB_PRIVATE N_NIMCALL(tyTuple__bRyhXH2W6bAwxmsy78A9c3g, get_hurtbox__combat_u46)(tyObject_CharactercolonObjectType___GNtIvodqMgdkSCDNOnirUw* character_p0);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, detect_hit__combat_u76)(NF32 area1_p0, NF32 area2_p1);
N_LIB_PRIVATE N_NIMCALL(void, damage__combat_u80)(tyObject_CharactercolonObjectType___GNtIvodqMgdkSCDNOnirUw* character_p0, NF32 damage_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, death__combat_u74)(tyObject_CharactercolonObjectType___GNtIvodqMgdkSCDNOnirUw* character_p0);
...
{nimErr_ = nimErrorFlag();
	{
		...
		sfx__pkgZnicoZbackendsZsdl2_u7205(((NI)1), ((NI)3), ((NI)1), 1.0f, 1.0f, INF);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		{
			if (!((*(*character_p0).heart).bpm <= 0.0f)) goto LA7_;
			sfx__pkgZnicoZbackendsZsdl2_u7205(((NI)2), ((NI)4), ((NI)1), 1.0f, 1.0f, INF);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
LA7_: ;
	}
...
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	vs_distance = ((NF32)((*character2_p1).position[(((NI)0))- 0]) - (NF32)((*character1_p0).position[(((NI)0))- 0]));
	(*character1_p0).distance_from_opp = vs_distance;
	(*character2_p1).distance_from_opp = vs_distance;
	c1_hitbox = get_hitbox__combat_u4(character1_p0, (*character1_p0).frame);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	c2_hitbox = get_hitbox__combat_u4(character2_p1, (*character2_p1).frame);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	c1_hurtbox = get_hurtbox__combat_u46(character1_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	c2_hurtbox = get_hurtbox__combat_u46(character2_p1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = detect_hit__combat_u76(c1_hurtbox.Field2, c2_hitbox.Field0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		damage__combat_u80(character1_p0, 30.0f);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
LA4_: ;
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = detect_hit__combat_u76(c1_hitbox.Field2, c2_hurtbox.Field0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T8_) goto LA9_;
		damage__combat_u80(character2_p1, 30.0f);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
LA9_: ;
	{
		if (!((*(*character1_p0).heart).bpm <= 0.0f)) goto LA13_;
		death__combat_u74(character1_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
LA13_: ;
	{
		if (!((*(*character2_p1).heart).bpm <= 0.0f)) goto LA17_;
		death__combat_u74(character2_p1);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
LA17_: ;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, show_hitboxes__combat_u61)(tyObject_CharactercolonObjectType___GNtIvodqMgdkSCDNOnirUw* character_p0, NI frame_p1) {
	tyTuple__bRyhXH2W6bAwxmsy78A9c3g hb;
	NI32 T1_;
	NI32 T2_;
	NI32 T3_;
	NI32 T4_;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	hb = get_hitbox__combat_u4(character_p0, frame_p1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T1_ = (NI32)0;
	T1_ = toPint__pkgZnicoZbackendsZcommon_u851(hb.Field0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T2_ = (NI32)0;
	T2_ = toPint__pkgZnicoZbackendsZcommon_u851(hb.Field1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T3_ = (NI32)0;
	T3_ = toPint__pkgZnicoZbackendsZcommon_u851(hb.Field2);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T4_ = (NI32)0;
	T4_ = toPint__pkgZnicoZbackendsZcommon_u851(hb.Field3);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	rect__pkgZnico_u258(T1_, T2_, T3_, T4_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
