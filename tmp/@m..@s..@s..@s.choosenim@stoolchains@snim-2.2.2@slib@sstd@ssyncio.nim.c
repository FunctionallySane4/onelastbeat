...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -pthread -flto -O3   -I/home/gregis/.choosenim/toolchains/nim-2.2.2/lib -I/home/gregis/Projects/OneLastBeat/src -o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@sstd@ssyncio.nim.c.o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@sstd@ssyncio.nim.c */
...
typedef NCSTRING tyArray__8nYxzubIGONtSxhG5ezZvw[5];
struct TNimTypeV2 {
	void* destructor;
	NI size;
	NI16 align;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, open__stdZsyncio_u411)(FILE** f_p0, NimStringV2 filename_p1, tyEnum_FileMode__NOotkCEDdzClfG8nOJdANg mode_p2, NI bufSize_p3);
...
} TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_4 = { 24 | NIM_STRLIT_FLAG, "cannot set file position" };
static const NimStringV2 TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_5 = {24, (NimStrPayload*)&TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_4};
static const struct {
  NI cap; NIM_CHAR data[29+1];
} TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_6 = { 29 | NIM_STRLIT_FLAG, "cannot retrieve file position" };
static const NimStringV2 TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_7 = {29, (NimStrPayload*)&TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_6};
static const struct {
  NI cap; NIM_CHAR data[7+1];
} TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_8 = { 7 | NIM_STRLIT_FLAG, "errno: " };
static const NimStringV2 TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_9 = {7, (NimStrPayload*)&TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_8};
static const struct {
  NI cap; NIM_CHAR data[2+1];
} TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_10 = { 2 | NIM_STRLIT_FLAG, " `" };
static const NimStringV2 TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_11 = {2, (NimStrPayload*)&TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_10};
static const struct {
  NI cap; NIM_CHAR data[1+1];
} TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_12 = { 1 | NIM_STRLIT_FLAG, "`" };
static const NimStringV2 TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_13 = {1, (NimStrPayload*)&TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_12};
N_LIB_PRIVATE NIM_CONST tyArray__8nYxzubIGONtSxhG5ezZvw FormatOpen__stdZsyncio_u402 = {"rbe",
"wbe",
"w+be",
"r+be",
"abe"}
...
{nimErr_ = nimErrorFlag();
	p = fopen(nimToCStringConv(filename_p1), FormatOpen__stdZsyncio_u402[(mode_p2)- 0]);
	{
		FILE* f2;
		struct stat res;
		...
		f2 = ((FILE*) (p));
		{
			...
			T7_ = (NIM_BOOL)0;
			T8_ = (int)0;
			T8_ = getFileHandle__stdZsyncio_u279(f2);
...
{nimErr_ = nimErrorFlag();
	result = 0;
	{
		...
		NimStringV2 T7_;
		T3_ = (NIM_BOOL)0;
		T3_ = open__stdZsyncio_u411(&result, filename_p0, mode_p1, bufSize_p2);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		T6_ = NIM_NIL;
...
appendString((&T7_), filename_p0);
		...
		raiseExceptionEx((Exception*)T6_, "IOError", "open", "syncio.nim", 788);
goto BeforeRet_;
	}
LA4_: ;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NOINLINE(void, raiseEIO__stdZsyncio_u92)(NimStringV2 msg_p0) {
	tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw* T2_;
	NimStringV2 blitTmp;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	T2_ = NIM_NIL;
	T2_ = (tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw*) nimNewObj(sizeof(tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw), NIM_ALIGNOF(tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw));
	(*T2_).Sup.Sup.Sup.m_type = (&NTIv2__YfyTxe9cThBYfr9aHkc9cltBw_);
	(*T2_).Sup.Sup.name = "IOError";
	blitTmp = msg_p0;
	eqwasMoved___system_u2687((&msg_p0));
	(*T2_).Sup.Sup.message = blitTmp;
	(*T2_).Sup.Sup.parent = ((Exception*) NIM_NIL);
	raiseExceptionEx((Exception*)T2_, "IOError", "raiseEIO", "syncio.nim", 157);
goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	result = ftello(f_p0);
	{
		...
		raiseEIO__stdZsyncio_u92(TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_7);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
LA3_: ;
	}BeforeRet_: ;
...
appendString((&T7_), TM__xNF6mvRQ4Pd1hTNM9cEHXwQ_13);
		...
		clearerr(f_p0);
		blitTmp = msg;
		eqwasMoved___system_u2687((&msg));
		raiseEIO__stdZsyncio_u92(blitTmp);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
				...
				while (1) {
					{
						...
						T10_ = (NIM_BOOL)0;
						T10_ = eqeq___system_u8792(T9_, ((NCSTRING) NIM_NIL));
						fgetsSuccess = !(T10_);
						{
...
LA17_: ;
			...
			m = memchr(((void*) ((&(*line_p1).p->data[pos]))), ((int)10), ((size_t) (sp)));
			{
				...
				last = (NI)(((NI) (ptrdiff_t) (m)) - ((NI) (ptrdiff_t) ((&(*line_p1).p->data[((NI)0)]))));
				{
					NIM_BOOL T25_;
					NIM_BOOL T29_;
					T25_ = (NIM_BOOL)0;
					T25_ = (((NI)0) < last);
					if (!(T25_)) goto LA26_;
					T25_ = ((NU8)((*line_p1).p->data[(NI)(last - ((NI)1))]) == (NU8)(13));
LA26_: ;
					if (!T25_) goto LA27_;
					setLengthStrV2((&(*line_p1)), ((NI)(last - ((NI)1))));
					T29_ = (NIM_BOOL)0;
					T29_ = (((NI)1) < last);
					if (T29_) goto LA30_;
					T29_ = fgetsSuccess;
...
LA27_: ;
				{
					...
					T32_ = (((NI)0) < last);
					if (!(T32_)) goto LA33_;
					T32_ = ((NU8)((*line_p1).p->data[(NI)(last - ((NI)1))]) == (NU8)(0));
LA33_: ;
					if (!T32_) goto LA34_;
					{
						NIM_BOOL T38_;
						T38_ = (NIM_BOOL)0;
						T38_ = ((NI)((NI)(pos + sp) - ((NI)1)) <= last);
						if (T38_) goto LA39_;
						T38_ = !(((NU8)((*line_p1).p->data[(NI)(last + ((NI)1))]) == (NU8)(0)));
LA39_: ;
						if (!T38_) goto LA40_;
						last -= ((NI)1);
					}
...
LA19_: ;
			pos += sp;
			sp = ((NI)128);
			setLengthStrV2((&(*line_p1)), ((NI)(pos + sp)));
		}
	}
	}BeforeRet_: ;
	return result;
