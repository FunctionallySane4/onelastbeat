...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -pthread -flto -O3   -I/home/gregis/.choosenim/toolchains/nim-2.2.2/lib -I/home/gregis/Projects/OneLastBeat/src -o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@sstd@sprivate@sdigitsutils.nim.c.o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@sstd@sprivate@sdigitsutils.nim.c */
...
static N_INLINE(void, addChars__stdZprivateZdigitsutils_u104)(NimStringV2* result_p0, tyArray__PbS9a6gkxCuxWEnFq4lOU9aw x_p1, NI start_p2, NI n_p3) {
	NI old;
	old = (*result_p0).len;
	setLengthStrV2((&(*result_p0)), ((NI)(old + n_p3)));
	copyMem__system_u1731(((void*) ((&(*result_p0).p->data[old]))), ((void*) ((&x_p1[(start_p2)- 0]))), (n_p3));
}
static N_INLINE(NIM_BOOL*, nimErrorFlag)(void) {
	NIM_BOOL* result;
...
{nimErr_ = nimErrorFlag();
	...
	next = ((NI)23);
	{
		while (1) {
			...
			tmp[(next)- 0] = digits100__stdZprivateZdigitsutils_u2[((NI16)(index + ((NI16)1)))- 0];
			tmp[((NI)(next - ((NI)1)))- 0] = digits100__stdZprivateZdigitsutils_u2[(index)- 0];
			next -= ((NI)2);
		} LA2: ;
	}
	{
...
LA5_: ;
	{
		...
		tmp[((NI)(next - ((NI)1)))- 0] = digits100__stdZprivateZdigitsutils_u2[(index_2)- 0];
		next -= ((NI)1);
	}
LA3_: ;
	addChars__stdZprivateZdigitsutils_u104(result_p0, tmp, next, (NI)(((NI)24) - next));
