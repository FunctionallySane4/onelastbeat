...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -pthread -flto -O3   -I/home/gregis/.choosenim/toolchains/nim-2.2.2/lib -I/home/gregis/Projects/OneLastBeat/src -o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@sstd@soserrors.nim.c.o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@sstd@soserrors.nim.c */
...
N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__g5aWKLnwFOcW9cBfUnw9cYgA*, newOSError__stdZoserrors_u53)(NI32 errorCode_p0, NimStringV2 additionalInfo_p1);
...
extern TNimTypeV2 NTIv2__g5aWKLnwFOcW9cBfUnw9cYgA_;
static const struct {
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, osErrorMsg__stdZoserrors_u13)(NI32 errorCode_p0) {
	...
	result = TM__1nRK0qvLEFLABF9aZnNtAXQ_3;
	{
		...
		eqsink___system_u2696((&result), T6_);
	}
LA3_: ;
	return result;
}
...
N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__g5aWKLnwFOcW9cBfUnw9cYgA*, newOSError__stdZoserrors_u53)(NI32 errorCode_p0, NimStringV2 additionalInfo_p1) {
	tyObject_OSError__g5aWKLnwFOcW9cBfUnw9cYgA* result;
	NI32 colontmpD_;
	tyObject_OSError__g5aWKLnwFOcW9cBfUnw9cYgA* T1_;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	result = NIM_NIL;
	colontmpD_ = (NI32)0;
	T1_ = NIM_NIL;
	T1_ = (tyObject_OSError__g5aWKLnwFOcW9cBfUnw9cYgA*) nimNewObj(sizeof(tyObject_OSError__g5aWKLnwFOcW9cBfUnw9cYgA), NIM_ALIGNOF(tyObject_OSError__g5aWKLnwFOcW9cBfUnw9cYgA));
	(*T1_).Sup.Sup.Sup.m_type = (&NTIv2__g5aWKLnwFOcW9cBfUnw9cYgA_);
...
LA4_: ;
	{
		...
		eqsink___system_u2696((&(*result).Sup.Sup.message), TM__1nRK0qvLEFLABF9aZnNtAXQ_7);
	}
LA15_: ;
	}BeforeRet_: ;
	return result;
