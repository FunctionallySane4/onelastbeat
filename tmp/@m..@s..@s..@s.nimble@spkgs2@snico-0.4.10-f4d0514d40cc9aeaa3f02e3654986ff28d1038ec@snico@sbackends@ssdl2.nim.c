...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -pthread -flto -O3   -I/home/gregis/.choosenim/toolchains/nim-2.2.2/lib -I/home/gregis/Projects/OneLastBeat/src -o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.nimble@spkgs2@snico-0.4.10-f4d0514d40cc9aeaa3f02e3654986ff28d1038ec@snico@sbackends@ssdl2.nim.c.o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.nimble@spkgs2@snico-0.4.10-f4d0514d40cc9aeaa3f02e3654986ff28d1038ec@snico@sbackends@ssdl2.nim.c */
...
N_NOCONV(tyObject_VorbisObj__5PzYikC9ahSxNpWoA19aAkYg*, stb_vorbis_open_file)(FILE* fp_p0, int close_handle_on_close_p1, int* error_p2, void* alloc_buffer_p3);
N_LIB_PRIVATE N_NIMCALL(void, close__stdZsyncio_u268)(FILE* f_p0);
N_LIB_PRIVATE N_NIMCALL(NI, findFreeChannel__pkgZnicoZbackendsZsdl2_u6856)(NF32 priority_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___pkgZnicoZbackendsZsdl2_u6933)(tyObject_Channel__in24RcHDml3U5CQrgcGk5g* dest_p0, tyObject_Channel__in24RcHDml3U5CQrgcGk5g* src_p1);
static N_INLINE(void, nimIncRef)(void* p_p0);
static N_INLINE(void, nimIncRefCyclic)(void* p_p0, NIM_BOOL cyclic_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___pkgZnicoZbackendsZsdl2_u6080)(tySequence__4Xyxy0Om14N6K1l5e9bUPSQ* dest_p0, tySequence__4Xyxy0Om14N6K1l5e9bUPSQ src_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pkgZnicoZbackendsZsdl2_u6930)(tyObject_Channel__in24RcHDml3U5CQrgcGk5g* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___pkgZnicoZbackendsZsdl2_u6683)(tyObject_SfxBuffercolonObjectType___lwjhdE2hrylQh0EU9aI9butg** dest_p0, tyObject_SfxBuffercolonObjectType___lwjhdE2hrylQh0EU9aI9butg* src_p1);
...
static const struct {
  NI cap; NIM_CHAR data[21+1];
} TM__lQXcKkYGF8KYpfC3LuZn2A_54 = { 21 | NIM_STRLIT_FLAG, "invalid music index: " };
static const NimStringV2 TM__lQXcKkYGF8KYpfC3LuZn2A_55 = {21, (NimStrPayload*)&TM__lQXcKkYGF8KYpfC3LuZn2A_54};
static const struct {
  NI cap; NIM_CHAR data[28+1];
} TM__lQXcKkYGF8KYpfC3LuZn2A_56 = { 28 | NIM_STRLIT_FLAG, "no music loaded into index: " };
static const NimStringV2 TM__lQXcKkYGF8KYpfC3LuZn2A_57 = {28, (NimStrPayload*)&TM__lQXcKkYGF8KYpfC3LuZn2A_56};
static const struct {
  NI cap; NIM_CHAR data[39+1];
} TM__lQXcKkYGF8KYpfC3LuZn2A_58 = { 39 | NIM_STRLIT_FLAG, "unable to open music file for reading: " };
static const NimStringV2 TM__lQXcKkYGF8KYpfC3LuZn2A_59 = {39, (NimStrPayload*)&TM__lQXcKkYGF8KYpfC3LuZn2A_58};
static const struct {
  NI cap; NIM_CHAR data[28+1];
} TM__lQXcKkYGF8KYpfC3LuZn2A_60 = { 28 | NIM_STRLIT_FLAG, "unable to open vorbis file: " };
static const NimStringV2 TM__lQXcKkYGF8KYpfC3LuZn2A_61 = {28, (NimStrPayload*)&TM__lQXcKkYGF8KYpfC3LuZn2A_60};
...
LA5_: ;
	T7_.len = 0; T7_.p = NIM_NIL;
	T7_ = nosjoinPath(assetPath__pkgZnicoZbackendsZcommon_u1021, filename_p1);
	if (NIM_UNLIKELY(*nimErr_)) {eqdestroy___system_u281(T7_); goto BeforeRet_;}
	eqsink___system_u2696((&musicFileLibrary__pkgZnicoZbackendsZsdl2_u141[(index_p0)- 0]), T7_);
	}BeforeRet_: ;
}
...
{nimErr_ = nimErrorFlag();
	{
		...
		resetChannel__pkgZnicoZbackendsZsdl2_u166((&audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0]));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		goto BeforeRet_;
	}
LA3_: ;
...
LA8_: ;
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		T12_ = NIM_NIL;
		T12_ = (Exception*) nimNewObj(sizeof(Exception), NIM_ALIGNOF(Exception));
		(*T12_).Sup.m_type = (&NTIv2__XEycrCsme5C8CVWAYEcdBQ_);
		(*T12_).name = "Exception";
		T13_.len = 0; T13_.p = NIM_NIL;
		colontmpD_ = dollar___systemZdollars_u8(index_p1);
		if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
		T13_ = rawNewString(colontmpD_.len + 21);
appendString((&T13_), TM__lQXcKkYGF8KYpfC3LuZn2A_55);
appendString((&T13_), colontmpD_);
		(*T12_).message = T13_;
		(*T12_).parent = ((Exception*) NIM_NIL);
		raiseExceptionEx((Exception*)T12_, "Exception", "music", "sdl2.nim", 1995);
goto LA11_;
		{
			LA11_:;
		}
...
LA9_: ;
	{
		...
		Exception* T21_;
		NimStringV2 T22_;
		if (!(musicFileLibrary__pkgZnicoZbackendsZsdl2_u141[(index_p1)- 0].len == 0)) goto LA18_;
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
		T21_ = NIM_NIL;
		...
		colontmpD__2 = dollar___systemZdollars_u8(index_p1);
		if (NIM_UNLIKELY(*nimErr_)) goto LA20_;
		T22_ = rawNewString(colontmpD__2.len + 28);
appendString((&T22_), TM__lQXcKkYGF8KYpfC3LuZn2A_57);
appendString((&T22_), colontmpD__2);
		(*T21_).message = T22_;
		(*T21_).parent = ((Exception*) NIM_NIL);
		raiseExceptionEx((Exception*)T21_, "Exception", "music", "sdl2.nim", 1998);
goto LA20_;
		{
			LA20_:;
		}
...
LA18_: ;
	{
		if (!!((audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].musicFile == ((tyObject_VorbisObj__5PzYikC9ahSxNpWoA19aAkYg*) NIM_NIL)))) goto LA27_;
		stb_vorbis_close(audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].musicFile);
		audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].musicFile = ((tyObject_VorbisObj__5PzYikC9ahSxNpWoA19aAkYg*) NIM_NIL);
	}
LA27_: ;
	fp = open__stdZsyncio_u484(musicFileLibrary__pkgZnicoZbackendsZsdl2_u141[(index_p1)- 0], ((tyEnum_FileMode__NOotkCEDdzClfG8nOJdANg)0), ((NI)-1));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw* T33_;
		NimStringV2 T34_;
		if (!(fp == ((FILE*) NIM_NIL))) goto LA31_;
		T33_ = NIM_NIL;
		T33_ = (tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw*) nimNewObj(sizeof(tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw), NIM_ALIGNOF(tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw));
		(*T33_).Sup.Sup.Sup.m_type = (&NTIv2__YfyTxe9cThBYfr9aHkc9cltBw_);
		(*T33_).Sup.Sup.name = "IOError";
		T34_.len = 0; T34_.p = NIM_NIL;
		T34_ = rawNewString(musicFileLibrary__pkgZnicoZbackendsZsdl2_u141[(index_p1)- 0].len + 39);
appendString((&T34_), TM__lQXcKkYGF8KYpfC3LuZn2A_59);
appendString((&T34_), musicFileLibrary__pkgZnicoZbackendsZsdl2_u141[(index_p1)- 0]);
		(*T33_).Sup.Sup.message = T34_;
		(*T33_).Sup.Sup.parent = ((Exception*) NIM_NIL);
		raiseExceptionEx((Exception*)T33_, "IOError", "music", "sdl2.nim", 2006);
goto BeforeRet_;
	}
LA31_: ;
	v = stb_vorbis_open_file(fp, ((int)1), ((int*) NIM_NIL), NIM_NIL);
	{
		tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw* T39_;
		NimStringV2 T40_;
		if (!(v == ((tyObject_VorbisObj__5PzYikC9ahSxNpWoA19aAkYg*) NIM_NIL))) goto LA37_;
		close__stdZsyncio_u268(fp);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T39_ = NIM_NIL;
		T39_ = (tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw*) nimNewObj(sizeof(tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw), NIM_ALIGNOF(tyObject_IOError__YfyTxe9cThBYfr9aHkc9cltBw));
		(*T39_).Sup.Sup.Sup.m_type = (&NTIv2__YfyTxe9cThBYfr9aHkc9cltBw_);
		(*T39_).Sup.Sup.name = "IOError";
		T40_.len = 0; T40_.p = NIM_NIL;
		T40_ = rawNewString(musicFileLibrary__pkgZnicoZbackendsZsdl2_u141[(index_p1)- 0].len + 28);
appendString((&T40_), TM__lQXcKkYGF8KYpfC3LuZn2A_61);
appendString((&T40_), musicFileLibrary__pkgZnicoZbackendsZsdl2_u141[(index_p1)- 0]);
		(*T39_).Sup.Sup.message = T40_;
		(*T39_).Sup.Sup.parent = ((Exception*) NIM_NIL);
		raiseExceptionEx((Exception*)T39_, "IOError", "music", "sdl2.nim", 2011);
goto BeforeRet_;
	}
LA37_: ;
	info = stb_vorbis_get_info(v);
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].kind = ((tyEnum_ChannelKind__awj6Vh1QQR9aUNCKmlUPn3g)3);
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].musicFile = v;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].musicIndex = index_p1;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].phase = 0.0f;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].freq = 1.0f;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].gain = 1.0f;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].loop = loop_p2;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].musicBuffer = ((NI)0);
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].musicStereo = (info.channels == ((NI32)2));
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_p0)- 0].musicSampleRate = ((NF32) (info.sample_rate));
	}BeforeRet_: ;
}
static N_INLINE(void, nimIncRef)(void* p_p0) {
	NI T1_;
...
LA4_: ;
	T6_ = src_p1.len;
	setLen__pkgZnicoZbackendsZsdl2_u6097((&(*dest_p0)), T6_);
	colontmp_ = ((NI)0);
	{
		while (1) {
			NI T9_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___pkgZnicoZbackendsZsdl2_u6933)(tyObject_Channel__in24RcHDml3U5CQrgcGk5g* dest_p0, tyObject_Channel__in24RcHDml3U5CQrgcGk5g* src_p1) {
	...
	{
		if (!(*src_p1).buffer) goto LA3_;
		nimIncRef((*src_p1).buffer);
	}
LA3_: ;
	{
		NIM_BOOL T7_;
		T7_ = (NIM_BOOL)0;
		T7_ = nimDecRefIsLast((*dest_p0).buffer);
		if (!T7_) goto LA8_;
		eqdestroy___pkgZnicoZbackendsZsdl2_u6698((*dest_p0).buffer);
		nimRawDispose((*dest_p0).buffer, ((NI)4));
	}
LA8_: ;
	(*dest_p0).buffer = (*src_p1).buffer;
	colontmp_ = (*dest_p0).callback.ClE_0;
	{
		if (!(*src_p1).callback.ClE_0) goto LA12_;
		nimIncRefCyclic((*src_p1).callback.ClE_0, NIM_TRUE);
	}
LA12_: ;
...
LA17_: ;
	(*dest_p0).callbackStereo = (*src_p1).callbackStereo;
	(*dest_p0).musicFile = (*src_p1).musicFile;
	(*dest_p0).musicIndex = (*src_p1).musicIndex;
	(*dest_p0).musicBuffer = (*src_p1).musicBuffer;
	(*dest_p0).musicStereo = (*src_p1).musicStereo;
	(*dest_p0).musicSampleRate = (*src_p1).musicSampleRate;
	nimCopyMem((void*)(*dest_p0).musicBuffers, (NIM_CONST void*)(*src_p1).musicBuffers, sizeof(tyArray__MLIYHgc9b3aVhhy7Dt9bea6g));
	(*dest_p0).loop = (*src_p1).loop;
	(*dest_p0).phase = (*src_p1).phase;
	(*dest_p0).freq = (*src_p1).freq;
	(*dest_p0).basefreq = (*src_p1).basefreq;
	(*dest_p0).targetFreq = (*src_p1).targetFreq;
	(*dest_p0).width = (*src_p1).width;
	(*dest_p0).pan = (*src_p1).pan;
	(*dest_p0).shape = (*src_p1).shape;
	(*dest_p0).gain = (*src_p1).gain;
	(*dest_p0).synthData.Field0 = (*src_p1).synthData.Field0;
	nimCopyMem((void*)(*dest_p0).synthData.Field1, (NIM_CONST void*)(*src_p1).synthData.Field1, sizeof(tyArray__8fYrKWsiK9cNFYjzjxgot2w));
	(*dest_p0).synthData.Field2 = (*src_p1).synthData.Field2;
	(*dest_p0).synthData.Field3 = (*src_p1).synthData.Field3;
	(*dest_p0).synthDataIndex = (*src_p1).synthDataIndex;
	(*dest_p0).init = (*src_p1).init;
	(*dest_p0).env = (*src_p1).env;
	(*dest_p0).envValue = (*src_p1).envValue;
	(*dest_p0).envPhase = (*src_p1).envPhase;
	(*dest_p0).length = (*src_p1).length;
	(*dest_p0).vibspeed = (*src_p1).vibspeed;
	(*dest_p0).vibamount = (*src_p1).vibamount;
	(*dest_p0).glide = (*src_p1).glide;
	(*dest_p0).pchange = (*src_p1).pchange;
	(*dest_p0).trigger = (*src_p1).trigger;
	(*dest_p0).lfsr = (*src_p1).lfsr;
	(*dest_p0).lfsr2 = (*src_p1).lfsr2;
	(*dest_p0).nextClick = (*src_p1).nextClick;
	(*dest_p0).outvalue = (*src_p1).outvalue;
	(*dest_p0).priority = (*src_p1).priority;
	nimCopyMem((void*)(*dest_p0).wavData, (NIM_CONST void*)(*src_p1).wavData, sizeof(tyArray__vEOa9c5qaE9ajWxR5R4zwfQg));
	eqcopy___pkgZnicoZbackendsZsdl2_u6080((&(*dest_p0).outputBuffer.data), (*src_p1).outputBuffer.data);
	(*dest_p0).outputBuffer.head = (*src_p1).outputBuffer.head;
	(*dest_p0).outputBuffer.tail = (*src_p1).outputBuffer.tail;
	(*dest_p0).outputBuffer.size = (*src_p1).outputBuffer.size;
	(*dest_p0).outputBuffer.length = (*src_p1).outputBuffer.length;
}
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pkgZnicoZbackendsZsdl2_u6930)(tyObject_Channel__in24RcHDml3U5CQrgcGk5g* dest_p0) {
	{
		NIM_BOOL T3_;
...
LA9_: ;
	eqdestroy___pkgZnicoZbackendsZsdl2_u6077((*dest_p0).outputBuffer.data);
}
N_LIB_PRIVATE N_NIMCALL(NI, findFreeChannel__pkgZnicoZbackendsZsdl2_u6856)(NF32 priority_p0) {
	NI result;
	NF32 lowestPriority;
...
{nimErr_ = nimErrorFlag();
	{
		...
		NI i;
		NI i_2;
		nimZeroMem((void*)(&c), sizeof(tyObject_Channel__in24RcHDml3U5CQrgcGk5g));
		i = (NI)0;
		i_2 = ((NI)0);
		{
			while (1) {
				i = i_2;
				eqcopy___pkgZnicoZbackendsZsdl2_u6933((&c), (&audioChannels__pkgZnicoZbackendsZsdl2_u143[(i_2)- 0]));
				{
					if (!(c.kind == ((tyEnum_ChannelKind__awj6Vh1QQR9aUNCKmlUPn3g)0))) goto LA7_;
					result = i;
					eqdestroy___pkgZnicoZbackendsZsdl2_u6930((&c));
					goto BeforeRet_;
				}
LA7_: ;
				{
					if (!(((NI)15) <= i_2)) goto LA11_;
					goto LA3;
				}
LA11_: ;
				i_2 += ((NI)1);
	...
	bestChannel = ((NI)-1);
	{
		tyObject_Channel__in24RcHDml3U5CQrgcGk5g c_2;
		NI i_3;
		NI i_4;
		nimZeroMem((void*)(&c_2), sizeof(tyObject_Channel__in24RcHDml3U5CQrgcGk5g));
		i_3 = (NI)0;
		i_4 = ((NI)0);
		{
			while (1) {
				i_3 = i_4;
				eqcopy___pkgZnicoZbackendsZsdl2_u6933((&c_2), (&audioChannels__pkgZnicoZbackendsZsdl2_u143[(i_4)- 0]));
				{
					if (!(c_2.priority < lowestPriority)) goto LA21_;
					lowestPriority = c_2.priority;
					bestChannel = i_3;
				}
LA21_: ;
				{
					if (!(((NI)15) <= i_4)) goto LA25_;
					goto LA17;
				}
LA25_: ;
				i_4 += ((NI)1);
		...
		{
			eqdestroy___pkgZnicoZbackendsZsdl2_u6930((&c_2));
		}
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	{
		NIM_BOOL T31_;
		T31_ = (NIM_BOOL)0;
		T31_ = (priority_p0 < lowestPriority);
		if (T31_) goto LA32_;
		T31_ = (bestChannel < ((NI)0));
LA32_: ;
		if (!T31_) goto LA33_;
		result = ((NI)-1);
		goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(void, sfx__pkgZnicoZbackendsZsdl2_u7205)(NI channel_p0, NI index_p1, NI loop_p2, NF32 gain_p3, NF32 pitch_p4, NF32 priority_p5) {
	NI colontmpD_;
	NI colontmpD__2;
	NI channel_2;
NIM_BOOL* nimErr_;
		...
		if (!T3_) goto LA5_;
		{
			...
			i_2 = ((NI)0);
			{
				while (1) {
					...
					i = i_2;
					resetChannel__pkgZnicoZbackendsZsdl2_u166((&audioChannels__pkgZnicoZbackendsZsdl2_u143[(i)- 0]));
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					i_2 += ((NI)1);
				} LA9: ;
			}
...
LA5_: ;
	{
		if (!(channel_p0 == ((NI)-1))) goto LA12_;
		colontmpD_ = findFreeChannel__pkgZnicoZbackendsZsdl2_u6856(priority_p5);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		channel_2 = colontmpD_;
	}
	goto LA10_;
LA12_: ;
	{
		colontmpD__2 = channel_p0;
		channel_2 = colontmpD__2;
	}
LA10_: ;
	{
		if (!(channel_2 == ((NI)-1))) goto LA17_;
		goto BeforeRet_;
	}
LA17_: ;
	{
		if (!(index_p1 < ((NI)0))) goto LA21_;
		resetChannel__pkgZnicoZbackendsZsdl2_u166((&audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_2)- 0]));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		goto BeforeRet_;
	}
LA21_: ;
	{
		if (!(((NI)63) < index_p1)) goto LA25_;
		goto BeforeRet_;
	}
LA25_: ;
	{
		if (!(sfxBufferLibrary__pkgZnicoZbackendsZsdl2_u140[(index_p1)- 0] == ((tyObject_SfxBuffercolonObjectType___lwjhdE2hrylQh0EU9aI9butg*) NIM_NIL))) goto LA29_;
		goto BeforeRet_;
	}
LA29_: ;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_2)- 0].kind = ((tyEnum_ChannelKind__awj6Vh1QQR9aUNCKmlUPn3g)2);
	eqcopy___pkgZnicoZbackendsZsdl2_u6683(&audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_2)- 0].buffer, sfxBufferLibrary__pkgZnicoZbackendsZsdl2_u140[(index_p1)- 0]);
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_2)- 0].phase = 0.0f;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_2)- 0].freq = pitch_p4;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_2)- 0].gain = gain_p3;
	audioChannels__pkgZnicoZbackendsZsdl2_u143[(channel_2)- 0].loop = loop_p2;
	}BeforeRet_: ;
}
