...
/* Command for C compiler:
   emcc -c -w -ferror-limit=3 -pthread -flto -O3   -I/home/gregis/.choosenim/toolchains/nim-2.2.2/lib -I/home/gregis/Projects/OneLastBeat/src -o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@spure@spathnorm.nim.c.o /home/gregis/Projects/OneLastBeat/tmp/@m..@s..@s..@s.choosenim@stoolchains@snim-2.2.2@slib@spure@spathnorm.nim.c */
...
typedef struct tyObject_PathIter__rxJYVpLSm6bKWhI1hiYT5Q tyObject_PathIter__rxJYVpLSm6bKWhI1hiYT5Q;
...
struct tyObject_PathIter__rxJYVpLSm6bKWhI1hiYT5Q {
	NI i;
	NI prev;
	NIM_BOOL notFirst;
};
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasNext__pureZpathnorm_u6)(tyObject_PathIter__rxJYVpLSm6bKWhI1hiYT5Q it_p0, NimStringV2 x_p1);
N_LIB_PRIVATE N_NIMCALL(tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ, next__pureZpathnorm_u10)(tyObject_PathIter__rxJYVpLSm6bKWhI1hiYT5Q* it_p0, NimStringV2 x_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, addNormalizePath__pureZpathnorm_u86)(NimStringV2 x_p0, NimStringV2* result_p1, NI* state_p2, NIM_CHAR dirSep_p3) {
	tyObject_PathIter__rxJYVpLSm6bKWhI1hiYT5Q it;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&it), sizeof(tyObject_PathIter__rxJYVpLSm6bKWhI1hiYT5Q));
...
LA45_: ;
					colontmpD_ = substr__system_u8826(x_p0, b.Field0, b.Field1);
...
LA58_: ;
				colontmpD__2 = substr__system_u8826(x_p0, b.Field0, b.Field1);
...
LA63_: ;
		if (!T62_) goto LA64_;
		eqsink___system_u2696((&(*result_p1)), TM__DfU0iuayCGwHDN1Exp9cbKg_3);
	}
LA64_: ;
	}BeforeRet_: ;
}
